                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-success" type="button" data-toggle="modal"
                                            data-target="#ModalEdit<?= $b->id?>"><i class="fas fa-pen"></i></a>
                                    </td>
                                        ...
                                        <div class="modal-dialog modal-lg" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h3 class="modal-title" id="myModalLabel">Beban : {{$b->keterangan}}
                                                    </h3>
                                                    ...
                                                    <div class="form-body">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group has-success">
                                                                    <label class="control-label">Kode</label>
                                                                    <input type="text" name="kode" id="kodeakun" value="{{$b->kode}}"
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group has-success">
                                                                    ...
                                                                    <input type="text" name="keterangan" id="keterangan"
                                                                        value="{{$b->keterangan}}" class="form-control "
                                                            ...
                                                            <div class="col-md-4">
                                                                ...
                                                                <div class="form-group has-success">
                                                                    ...
                                                                    <input type="text"
                                                                        ...
                                                                        name="biaya" value="{{$b->biaya}}" placeholder="biaya"
                                                                        autocomplete="off">
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group has-success">
                                                                    ...
                                                                    <input type="text"
                                                                        class="form-control form-control-danger"
                                                                        name="jumlah" value="{{$b->jumlah}}" placeholder="jumlah"
                                                                        autocomplete="off">
